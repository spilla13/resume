...
\begin{document} 
  ...
  \address{%
    \scalebox{0.86}[1]{\faEnvelopeAlt}\hspace{1mm}\href{mailto:billy.rhoades@mst.edu}{billy.rhoades@mst.edu}\\
    \Small\faPhoneSign\hspace{1mm}\phoneNumber
  }
  \address{%
  ...
  \begin{resume} 
    ...
    \section{Experience}
       ...
       Student Lead\hfill February 2013 -- June 2013
       \begin{itemize} \itemsep -1pt  % reduce space between items
       ...
       Student Support Analyst\hfill February 2011 -- February 2013
       \begin{itemize} \itemsep -1pt  % reduce space between items
